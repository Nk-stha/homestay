...
const packages = [
  {
    icon: 'hiking',
    title: 'Roots of the Jungle',
    duration: '3 Nights / 4 Days',
    description: 'A perfect introduction to Bardia\'s wildlife and culture. Guided walks and village tours.',
    featured: false,
  },
  {
    icon: 'binoculars',
    title: 'The Jungle Diaries',
    duration: '3 Nights / 4 Days',
    description: 'Focused on jeep safaris and animal tracking. Best for photographers and enthusiasts.',
    featured: true,
  },
  {
    icon: 'visibility',
    title: 'Tracking the Wild',
    duration: '4 Nights / 5 Days',
    description: 'A deeper immersion into the park\'s wilderness. Extended safaris and night walks.',
    featured: false,
  },
];
          ...
          {packages.map((pkg, index) => (
            <div
              ...
              className={`bg-[#D3D6C1] dark:bg-[#3D4035] p-8 rounded-lg relative group transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl scroll-fade-in stagger-${index + 1} ${
                pkg.featured ? 'shadow-xl border-b-4 border-primary ring-2 ring-primary/20' : 'hover:shadow-xl'
            ...
            >
              ...
              <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-white dark:bg-gray-800 p-3 rounded-full shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                <svg className="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 24 24">
                  {pkg.icon === 'hiking' && <path d="M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zM9.8 8.9L7 23h2.1l1.8-8 2.1 2v6h2v-7.5l-2.1-2 .6-3C14.8 12 16.8 13 19 13v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.4-.6-1-1-1.7-1-.3 0-.5.1-.8.1L6 8.3V13h2V9.6l1.8-.7" />}
                  {pkg.icon === 'binoculars' && <path d="M7 3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h2c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H7zm8 0c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h2c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-2z" />}
                  {pkg.icon === 'visibility' && <path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z" />}
                </svg>
              </div>
              ...
              <div className="mt-8 text-center">
                ...
                <button className={`btn-brush text-sm ${pkg.featured ? 'btn-brush-primary' : ''}`}
